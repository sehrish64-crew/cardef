...
const to = process.env.TO || '[REDACTED-REMOVED]'

async function main() {
  const subject = encodeURIComponent('Test Email from Carreaders')
  const html = encodeURIComponent('<h1>This is a test email from Carreaders</h1>')
